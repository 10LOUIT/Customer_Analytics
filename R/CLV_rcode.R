...
# set the "history" transaction time scope
# startDate_history <- as.Date("20140101","%Y%m%d")
# endDate_history <- as.Date("20141231","%Y%m%d")

#  set the "forecast" transaction time scope which are a bi-month purchasing cycle time
# startDate_forcast <- as.Date("20150101","%Y%m%d")
# endDate_forcast <- as.Date("20150301","%Y%m%d")
